...
#Add Linkedin URLs which are the targeted group OR
links = []

#Add Linkedin links in a CSV file and read from a dataframe
'''
df = pd.read_csv('filename.csv')
links = df["column1"].tolist()
'''
